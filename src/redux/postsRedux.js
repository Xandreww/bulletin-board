...
export const addPostRequest = (data) => {
  return (dispatch, getState) => {
    ...
    Axios.post(`${api.url}/${api.posts}`, data, { headers: { 'Content-Type': 'multipart/form-data' } })
      .then((res) => {
...
export const updatePostRequest = (id, data) => {
  return (dispatch, getState) => {
    ...
    Axios.put(`${api.url}/${api.posts}/${id}`, data, { headers: { 'Content-Type': 'multipart/form-data' } })
      .then((res) => {
